...
if(isMobile()){
	...
	/*else if(t.title == '카탈로그 다운로드'){
		...
		t.value = 'http://www.hyundai.com/mobile/quotation/main.do?carcode=RV104';
		return o.createElement("li", {key: e}, o.createElement("button", {onClick: n(t)}, t.title))
	}else if(t.title == '온라인 시승 예약 페이지 이동'){
		t.value = 'http://www.hyundai.com/mobile/tda/index.do';
		return o.createElement("li", {key: e}, o.createElement("button", {onClick: n(t)}, t.title))
	}*/
	else{
...
o.createElement("div", {className: "hidden", alt:e.content.card_value})
    ...
    if (isMobile()) {
        ...
        car_buttons[3]['type'] = "imBack";
        car_buttons[3]['title'] = "견적 바로가기";
        //car_buttons[3]['value'] = "https://logon.hyundai.com/mobile/quotation/main.do?carcode=RV104";
        car_buttons[3]['value'] = "견적 바로가기";
        ...
        var r = n(13),
            ...
            a = function(t) {
			    ...
			    if ((t.props.inputText === ''
                                || t.props.inputText === 'Hot한 영상'
                                || t.props.inputText === 'Kona의 주요특징'
				|| t.props.inputText === '라이프스타일별 차량 추천'
				|| t.props.inputText === '견적 내기'
				|| t.props.inputText === '시승신청') && (t.textInput.value !== '')) {
...
var directLine = new DirectLine.DirectLine({
    secret: "ESs67wQuHEU.cwA.n68.mCn3MxOGn6n-RdKewUGycdCoH0cNesHS0hCcpVFswbs",
    webSocket: false
});
function tenSecond() {
...
function appendLoadingDiv() {
	...
	if(msgHeight < 6){
		$('.loadingMsg > p').css({'height':'11px', 'padding-top':'14px'});	//KSO
	}
